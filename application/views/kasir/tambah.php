...
<body id="page-top">
									...
									<form action="<?= base_url('kasir/proses_tambah') ?>" id="form-tambah" method="POST">
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<input type="text" name="id_kasir" placeholder="Masukkan Kode Kasir" autocomplete="off" class="form-control" required value="KASIR<?= mt_rand(10, 99) ?>" maxlength="8" readonly>
											</div>
											<div class="form-group col-md-6">
	...
	<!-- <script>
		$(document).ready(function() {
			let username_kasir = $('input[name="id_kasir"]').val().split(' - ');
